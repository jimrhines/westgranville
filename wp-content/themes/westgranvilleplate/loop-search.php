...
<?php if ( $wp_query->max_num_pages > 1 ) : ?>
	<nav id="nav-above" class="navigation">
		<div class="nav-previous"><?php next_posts_link( __( '<span class="meta-nav">&larr;</span> Older results', 'boilerplate' ) ); ?></div>
		<div class="nav-next"><?php previous_posts_link( __( 'Newer results <span class="meta-nav">&rarr;</span>', 'boilerplate' ) ); ?></div>
	</nav><!-- #nav-above -->
<?php endif; ?>
			...
			<div class="entry-content">
				...
				<?php else : ?>
					...
					?>
						...
						<p><em><?php printf( __( 'This gallery contains <a %1$s>%2$s photos</a>.', 'boilerplate' ), 'href="' . get_permalink() . '" title="' . sprintf( esc_attr__( 'Permalink to %s', 'boilerplate' ), the_title_attribute( 'echo=0' ) ) . '" rel="bookmark"', $total_images ); ?></em></p>
					<?php endif; ?>
					<?php the_excerpt(); ?>
				<?php endif; ?>
			</div><!-- .entry-content -->
...
<?php if (  $wp_query->max_num_pages > 1 ) : ?>
	<nav id="nav-below" class="navigation">
		<?php next_posts_link( __( '&larr; Older results', 'boilerplate' ) ); ?>
		<?php previous_posts_link( __( 'Newer results &rarr;', 'boilerplate' ) ); ?>
	</nav><!-- #nav-below -->
<?php endif; ?>